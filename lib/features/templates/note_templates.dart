...
const kNoteTemplates = <NoteTemplate>[
  ...
  NoteTemplate('بيانات مهمة', Icons.info,
      'العنوان:\nالقيمة:\nملاحظات:\n'),
  NoteTemplate('قائمة مهام اليوم', Icons.checklist,
      'الأولويات (٣ الأهمّ):\n1. \n2. \n3. \n\nمهام أخرى:\n- \n- \n\nمؤجَّل للغد:\n- \n'),
  NoteTemplate('أهداف الأسبوع', Icons.flag,
      'الأسبوع:\n\nالأهداف:\n- \n- \n\nخطوات هذا الأسبوع:\n- \n\nمراجعة نهاية الأسبوع:\n'),
  NoteTemplate('قرار وتقييم', Icons.balance,
      'القرار المطلوب:\n\nالخيارات:\n1. \n2. \n\nالإيجابيات/السلبيات:\n- \n\nالقرار النهائي:\nالسبب:\n'),
  NoteTemplate('مكالمة/تواصل', Icons.call,
      'مع مَن:\nالتاريخ:\nالموضوع:\n\nأهم النقاط:\n- \n\nالمطلوب متابعته:\n- \n'),
];
