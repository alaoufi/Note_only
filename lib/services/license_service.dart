...
class LicenseService {
  ...
  // توليد رموز منه. هذا هو مفتاح **مولّد المالك المعتمَد** (نظام UNI3): نفس
  // البذرة السرّية في المولّد تُنتج أكواد كل الأجهزة، والتطبيق يقبلها بالمفتاح
  // العامّ المطابق أدناه. مفتاح واحد معتمَد = مولّد واحد لكل الأجهزة.
  static const List<String> _publicKeysB64 = [
    'W5Kc9hRB7lb9xSh/VqdR4T8GT6VaDznEwYQgXZpLZz0=', // مفتاح مولّد المالك المعتمَد
  ];

  // المفتاح الأساسي (للفحوص العامّة/التوثيق).
  static String get _publicKeyB64 => _publicKeysB64.first;

  // بادئة الرسالة الموقَّعة (يجب أن تطابق المولّد حرفيًّا): UNI3.
  static const List<String> _msgPrefixes = ['UNI3'];

  // ملح معرّف الجهاز (ثابت — يدخل في اشتقاق رقم الجهاز من عتاده).
